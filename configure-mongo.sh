...
db.createUser({user: '$APPLICATION_USER', pwd: '$APPLICATION_PASS', roles:[{role:'dbAdmin', db:'$APPLICATION_DATABASE'}, {role:'readAnyDatabase', db:'$APPLICATION_DATABASE'}, {role:'readWriteAnyDatabase', db:'$APPLICATION_DATABASE'}]})
EOF
fi
